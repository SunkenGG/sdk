...
public interface PlatformProvider {
    ...
    /**
     * Bakes the given {@link TabListEntry tab list entry} into a format what can be sent to players.
     *
     ...
     */
    @NotNull
    Object bakeEntry(@NotNull TabListEntry entry, @NotNull Set<GameFeature> gameFeatures);
