...
public class TabListPacketEventsProvider implements PlatformProvider {
    private final PacketEventsAPI<?> api;
    private final Set<GameFeature> supportedFeatures;

    public TabListPacketEventsProvider(@NotNull PacketEventsAPI<?> api) {
        this.api = api;
    ...
    @Override
    @NotNull
    public Object bakeEntry(@NotNull TabListEntry entry, @NotNull Set<GameFeature> gameFeatures) {
