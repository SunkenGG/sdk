...
/**
 * A template what holds all the entries for a {@link TabListTabList tab list}.
 *
 * <p>There are multiple ways to provide entries for a template:</p>
 *
 * <ul>
 *  <li> you can use {@link TabListEntryProvider entry providers} to provide lines
 *  with methods backed by {@link #provider(int, TabListEntryProvider)}, or
 ...
 *
 * @see TabListEntry
 * @see TabListEntryProvider
 */
public abstract class TabListTemplate {
    /**
     * The default {@link TabListEntryProvider entry provider}.
     */
    public static final TabListEntryProvider DEFAULT_PROVIDER = TabListEntryProvider.entryProvider(empty(), TextureProperty.QUESTION_MARK, -1);
    ...
    /**
     * The combined size of the {@link TabListTemplate#entries array}.
     */
    public static final int TEMPLATE_MAX_SIZE = TEMPLATE_MAX_COLUMNS * TEMPLATE_MAX_ROWS;

    private final TabListEntry[] entries;
    private final TabListHeaderAndFooter headerAndFooter;

    /**
     * Creates a new template.
     */
    public TabListTemplate() {
        this.entries = new TabListEntry[TEMPLATE_MAX_SIZE];
        this.headerAndFooter = new TabListHeaderAndFooter();

        for (int i = 0; i < TEMPLATE_MAX_SIZE; i++) {
            this.entries[i] = new TabListEntry(i, defaultProvider());
        }
    }
     ...
     * with {@link TabListTemplate#updateEntryStates() updateEntryStates()}.</p>
     */
    public void update() {
        // empty
    }
    ...
    /**
     * Returns the {@link TabListEntryProvider entry provider} for entries without content.
     *
     * @return the default provider
     */
    @NotNull
    public TabListEntryProvider defaultProvider() {
    ...
    /**
     * Sets the text, skin and ping property of a {@link TabListEntry tab list entry} to its default value.
     *
    ...
    /**
     * Sets the text, skin and ping property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x        the x position of the entry
     * @param y        the y position of the entry
     * @param provider the provider
     */
    public final void set(int x, int y, @NotNull TabListEntryProvider provider) {
     ...
     * @param provider the provider
     */
    public final void set(int pos, @NotNull TabListEntryProvider provider) {
        set(pos, provider.text(), provider.skin(), provider.ping());
    }

    /**
     * Sets the text property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x    the x position of the entry
     * @param y    the y position of the entry
     * @param text the text
    ...
    /**
     * Sets the skin property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x    the x position of the entry
     * @param y    the y position of the entry
     * @param skin the skin
    ...
    /**
     * Sets the ping property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x    the x position of the entry
     * @param y    the y position of the entry
     * @param ping the ping
    ...
    /**
     * Sets the text and ping property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x    the x position of the entry
     * @param y    the y position of the entry
     * @param text the text
    ...
    /**
     * Sets the text and skin property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x    the x position of the entry
     * @param y    the y position of the entry
     * @param text the text
    ...
    /**
     * Sets the skin and ping property of a {@link TabListEntry tab list entry} at the given position.
     *
     * @param x    the x position of the entry
     * @param y    the y position of the entry
     * @param skin the skin
    ...
    /**
     * Sets the text, skin and ping property of the {@link TabListEntry tab list entry} at the given position.
     *
     * @param pos  the position of the entry
     * @param text the text
     * @param skin the skin
    ...
    public final void set(int pos, @NotNull Component text, @NotNull TextureProperty skin, int ping) {
        TabListEntry container = this.entries[pos];
    ...
    /**
     * Sets the {@link TabListEntryProvider entry provider} of the {@link TabListEntry tab list entry} at the given position.
     *
     * @param x        the x position of the entry
     * @param y        the y position of the entry
     * @param provider the provider
     ...
     */
    public final void provider(int x, int y, @NotNull TabListEntryProvider provider) {
     ...
     * the provider gets removed.
     */
    public final void provider(int pos, @NotNull TabListEntryProvider provider) {
        this.entries[pos].setEntryProvider(provider);
    }

    /**
     * Returns the text of the {@link TabListEntry tab list entry} at the given position.
     *
     * @param pos the position of the entry
     * @return the text
     */
    ...
    @NotNull
    private Component currentText(@NotNull TabListEntry container) {
    ...
    /**
     * Returns the skin of the {@link TabListEntry tab list entry} at the given position.
     *
     * @param pos the position of the entry
     * @return the skin
     */
    ...
    @NotNull
    private TextureProperty currentSkin(@NotNull TabListEntry container) {
    ...
    /**
     * Returns the ping of the {@link TabListEntry tab list entry} at the given position.
     *
     * @param pos the position of the entry
     * @return the ping
     */
    ...
    private int currentPing(@NotNull TabListEntry container) {
    ...
    /**
     * Converts a 2-dimensional position into a {@link TabListEntry tab list entry} position.
     *
    ...
    /**
     * Returns the {@link TabListEntry entries} of this template.
     *
     * @return the entries
     */
    @ApiStatus.Internal
    public final TabListEntry[] entries() {
        return this.entries;
    }

    /**
     * Returns the {@link TabListHeaderAndFooter header and footer} of this template.
     *
     * @return the header and footer
     */
    @ApiStatus.Internal
    public final TabListHeaderAndFooter headerAndFooter() {
